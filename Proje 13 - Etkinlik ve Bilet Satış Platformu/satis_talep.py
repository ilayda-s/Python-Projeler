...
"")
        ...
        self.pushButton.setStyleSheet("background-color: rgb(255, 191, 117);\n"
"\n"
"\n"
"")
        self.pushButton.setObjectName("pushButton")
        self.label_4 = QtWidgets.QLabel(self.centralwidget)
        self.label_4.setGeometry(QtCore.QRect(570, 110, 221, 31))
        font = QtGui.QFont()
        font.setFamily("Cascadia Mono SemiBold")
        font.setPointSize(18)
        font.setBold(True)
    ...
    def retranslateUi(self, MainWindow):
        ...
        item.setText(_translate("MainWindow", "Etkinlik Tarihi"))
        item = self.tableWidget.horizontalHeaderItem(2)
        item.setText(_translate("MainWindow", "Etkinlik Mekanı"))
        self.label_2.setText(_translate("MainWindow", "Satışlar"))
        self.label_3.setText(_translate("MainWindow", "Bilet Bilgisi"))
        ...
        item.setText(_translate("MainWindow", "Bilet Numarası"))
        item = self.tableWidget_2.horizontalHeaderItem(1)
        item.setText(_translate("MainWindow", "Etkinlik Bilgileri"))
        self.pushButton.setText(_translate("MainWindow", "Geri"))
        self.label_4.setText(_translate("MainWindow", "Kullanıcılar"))
        ...
        item.setText(_translate("MainWindow", "Kullanıcı Ad/Soyad"))
        item = self.tableWidget_3.horizontalHeaderItem(1)
        item.setText(_translate("MainWindow", "Kullanıcı No"))
        item = self.tableWidget_3.horizontalHeaderItem(2)
        item.setText(_translate("MainWindow", "Bilet Alımı"))
